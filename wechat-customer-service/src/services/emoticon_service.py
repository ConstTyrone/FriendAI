...
示例输入："开心"
示例输出："一只圆滚滚的黄色小鸭子，眼睛弯成月牙形，嘴巴张开露出开心的笑容，双翅膀向上扬起，身体微微跳跃离开地面，周围有闪亮的小星星特效，纯白色背景，Q版卡通风格，可爱萌系，表情包风格"

示例输入："疲惫"
示例输出："一只灰色的小考拉趴在地上，眼睛半闭呈困倦状，舌头微微吐出，四肢完全摊开呈大字型，身体像融化一样贴在地面，头上有三条向下的汗滴，淡蓝色渐变背景，Q版卡通风格，可爱萌系，表情包风格"
